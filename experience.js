const experienceRoles = [
  {
    ...
    summary: "Supporting adolescents and families through crisis, treatment, and ongoing safety planning.",
    skills: ["Risk and safety assessment", "Crisis response", "Care coordination"],
  },
  {
    period: "2021 - 2023",
    ...
    summary: "Led child-safety investigations, from intake and interviews to safety planning, court reports, and recommendations.",
    skills: ["Investigative interviewing", "Legal documentation", "Multidisciplinary collaboration"],
  },
  {
    period: "2020 - 2021",
    ...
    summary: "Connected youth with practical resources and supported their transition toward independent adulthood.",
    skills: ["Resource navigation", "Youth advocacy", "Court documentation"],
  },
  {
    period: "2019 - 2020",
